...
var generate = function () 
{
	...
	if (isNaN(intCount) || intCount > 100 || intCount < 1) //validates that the input between 1 and 100
    {
        stringOutput = "Please choose a number between 1 and 100.";
        $("total_fib").value = " ";
    }
        ...
        while (intCount > 2) 
    {
         ...
         intCount--;  //sets the fibonacci calculation
     }
    }
